...
public class VideosController {
    ...
    //Filmes ou videos de graça
    @GetMapping("/free")
    public ResponseEntity<List<Videos>> showFreeVideos() {
        List<Videos> videos = videosRepository.findByPaymente(1);

        System.out.println("Vídeos encontrados: " + videos.size());
